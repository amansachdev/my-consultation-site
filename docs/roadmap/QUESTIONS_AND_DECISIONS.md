...
| Q-BIZ-03 | Business | What are the consultation fees for each service type? | MVP psychiatric consultation fee is decided as ₹500, inclusive of GST; additional service pricing remains future work. | Admin / Clinician | Decided |
...
| D-BIZ-01 | MVP psychiatric consultation price is **₹500 inclusive of GST**; payment is required before the booking request is submitted | Defines the current Razorpay order amount while leaving invoices, refund policy, and payout logic for later scope. | 2026-09-15 | Admin |
