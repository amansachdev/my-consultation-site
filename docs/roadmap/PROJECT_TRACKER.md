...
| M4 | Booking, Calendar & Availability | MVP | In Progress | Direct guest and signed-in booking requests, Cosmos persistence, Resend owner notification, service catalogue, clinician availability slots, appointment booking/reschedule/cancel, timezone handling | Q-BIZ-02 (online vs in-person), Q-BIZ-03 (pricing), Q-CLIN-07 (follow-up window) |
