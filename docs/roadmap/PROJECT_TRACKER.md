...
| M10 | Admin Panel & Operations | MVP | In Progress | Role-gated admin workspace with shared availability management, blocked dates/slots, and prescription workspace is implemented; patient/clinician management, appointment ops, payment/refund ops, support tickets, analytics, and audit viewer are not | Q-LEGAL-04 (grievance officer), Q-BIZ-05 (payout rules) |
